...
<div id="mc-title">
	...
	<div class="mc-toolbar" id="toolbar">
		<ul>
			...
			<?php echo $this->Html->link(__('Back'), array('controller' => 'programs', 'action' => 'view', $this->data['Program']['id'])); ?>
			</li>

			<li class="button special" id="toolbar-new">
			<a href="#" onClick="JavaScript:document.forms.ProgramEditForm.submit()" class="toolbar">
			Save
			</a>
			</li>
