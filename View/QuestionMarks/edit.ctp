...
<?php echo $this->Form->create('QuestionMark');?>
	<fieldset>
		<legend><?php echo __('Edit Question Mark'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QuestionMark.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('QuestionMark.id'))); ?></li>
